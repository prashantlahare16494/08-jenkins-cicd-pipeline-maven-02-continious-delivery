    ...
    stages{
        ...
        stage("Static Code Analysis (SonarQube)"){
            steps{
                ...
                //   sh "mvn clean verify -DskipITs=true sonar:sonar -Dsonar.host.url=http://ec2-18-118-200-67.us-east-2.compute.amazonaws.com:9000   -Dsonar.projectName=08-jenkins-cicd-pipeline-maven-01-continious-integration -Dsonar.projectKey=08-jenkins-cicd-pipeline-maven-01-continious-integration -Dsonar.projectVersion=$BUILD_NUMBER";
