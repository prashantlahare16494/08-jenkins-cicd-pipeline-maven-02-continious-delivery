    ...
    stages{
        ...
        stage("Static Code Analysis (SonarQube)"){
            steps{
                ...
                //   sh "mvn clean verify -DskipITs=true sonar:sonar -Dsonar.host.url=http://ec2-3-128-204-50.us-east-2.compute.amazonaws.com:9000   -Dsonar.projectName=08-jenkins-cicd-pipeline-maven-01-continious-integration -Dsonar.projectKey=08-jenkins-cicd-pipeline-maven-01-continious-integration -Dsonar.projectVersion=$BUILD_NUMBER";
                    sh "mvn clean package clean package -Dsurefire.skip=true sonar:sonar -Dsonar.host.url=http://ec2-3-128-204-50.us-east-2.compute.amazonaws.com:9000   -Dsonar.projectName=08-jenkins-cicd-pipeline-maven-02-continious-delivery -Dsonar.projectKey=08-jenkins-cicd-pipeline-maven-02-continious-delivery -Dsonar.projectVersion=$BUILD_NUMBER";
               }  
            }           
        }
	    ...
	    stage ('Clean Up : Stop the Stagin Server') {	          
           steps {
